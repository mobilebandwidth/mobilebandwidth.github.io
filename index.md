...
| -------------------------------- | -------------------------------- | -------------- | ----------| -----------|
| Section 3.3, last paragraph   | In comparison, for 4G networks, we find that the average bandwidth at different times of the days is in general <font color='red'><b>positively</b></font> correlated with the number of tests conducted by users. | In comparison, for 4G networks, we find that the average bandwidth at different times of the days is in general <font color='blue'><b>negatively</b></font> correlated with the number of tests conducted by users. | Typo | Lei Zhang from UCAS |
